...
class PGate : public LineInfo {
    ...
    public:
      ...
      virtual void elaborate_single(Design*des, NetScope*scope) const;
      virtual void elaborate_dual(Design*des, NetScope*scope) const;
      virtual void elaborate_bidir_dual(Design*des, NetScope*scope) const;
...
class PMemAssign  : public PGate {

    public:
      explicit PMemAssign(svector<PExpr*>*pins);
      ~PMemAssign();

      //virtual void elaborate(Design*des, NetScope*scope, string mode) const;
      virtual void elaborate_single(Design*des, NetScope*scope) const;
      virtual void elaborate_dual(Design*des, NetScope*scope) const;
      virtual void elaborate_bidir_dual(Design*des, NetScope*scope) const;
...
class PSquareAssign  : public PGate {

    public:
      explicit PSquareAssign(svector<PExpr*>*pins);
      ~PSquareAssign();
...
class PMultAssign  : public PGate {

    public:
      explicit PMultAssign(svector<PExpr*>*pins);
      ~PMultAssign();
...
class PMultAddAssign  : public PGate {

    public:
      explicit PMultAddAssign(svector<PExpr*>*pins);
      ~PMultAddAssign();
...
class PMultAccumAssign  : public PGate {

    public:
      explicit PMultAccumAssign(svector<PExpr*>*pins);
      ~PMultAccumAssign();
