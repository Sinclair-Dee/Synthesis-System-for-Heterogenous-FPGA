...
//std::string Attrib::attribute_adu(std::string key){
//	std::vector<cell_adu_>::iterator ite;
//	for (ite = list_adu_.begin(); ite != list_adu_.end(); ite++)
//	{
//		if(ite->key_ == key)
//			return ite->val_;
//	}
...
//void Attrib::attribute_adu(const std::string key, const std::string value){
//	std::vector<cell_adu_>::iterator ite;
//	for (ite = list_adu_.begin(); ite != list_adu_.end(); ite++)
//	{
//		if(ite->key_ == key)
//			return;
//	}
//	cell_adu_ tmp = {key, value};
//	list_adu_.push_back(tmp);
//}
