...
extern void pform_make_pmemassign(svector<PExpr*>*elist,
				     const char* fn, unsigned lineno);
extern void pform_make_psquareassign(svector<PExpr*>*elist,
				     const char* fn, unsigned lineno);
extern void pform_make_pmultassign(svector<PExpr*>*elist,
				     const char* fn, unsigned lineno);
extern void pform_make_pmultaddassign(svector<PExpr*>*elist,
				     const char* fn, unsigned lineno);
extern void pform_make_pmultaccumassign(svector<PExpr*>*elist,
				     const char* fn, unsigned lineno);
