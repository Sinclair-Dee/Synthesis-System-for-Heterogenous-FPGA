...
struct dll_target  : public target_t, public expr_scan_t {
	  ...
	  void lpm_lmultout(const NetLMultSimpleOUT*);
      void lpm_mult_add(const NetMultAdd*);
	  void lpm_mult_addout(const NetMultAddOut*);
	  void lpm_mult_accum(const NetMultAccum*);
      void lpm_HalfDSPBlock(const HalfDSPBlock*);
...
struct ivl_lpm_s {
      ...
      union {
	    ...
	    struct ivl_lpm_mult_s {
		  ...
		  ivl_nexus_t clken, aclr, clock, accum_sload, clock0, clock1, clock2, clock3, aclr0, aclr1, aclr2, aclr3, ena0, ena1, ena2, ena3, signa,signb,overflow;
		  ivl_nexus_t*data, *dataa, *datab, *sum, *scanouta, *scanoutb, *result;
	    } mult;
		struct ivl_lpm_multout_s {
			unsigned width_data;
			unsigned width_dataa;
			unsigned width_datab;
			unsigned width_datac;
			unsigned width_datad;
			unsigned width_addnsub;
			unsigned width_accumsload;
			unsigned width_result;
			ivl_nexus_t clken, aclr, clock, clock0, clock1, clock2, clock3, aclr0, aclr1, aclr2, aclr3, ena0, ena1, ena2, ena3, signa,signb,overflow;
			ivl_nexus_t*data, *dataa, *datab, *datac, *datad, *addnsub,*accumsload,*sum,*scanouta, *scanoutb, *result;
		} multout;

		struct ivl_lpm_halfdspblock_s {
				unsigned width_dataa0, width_datab0, width_dataa1, width_datab1;
				unsigned width_dataa2, width_datab2, width_dataa3, width_datab3;
				unsigned width_scanina, width_scanouta;
				unsigned width_chainin, width_chainout;
				unsigned width_clock,  width_ena, width_aclr;
				unsigned  width_zeroloopback, 
								width_accumsload, 
								width_zerochainout, 
								width_chainoutround, 
								width_chainsaturate, 
								...
								width_rotate, 
								width_shiftright;
				unsigned width_OverFlow;
				unsigned width_ChainOutSatOverFlow;
				unsigned width_result;

				ivl_nexus_t 	*dataa0, *datab0,*dataa1, *datab1, 
