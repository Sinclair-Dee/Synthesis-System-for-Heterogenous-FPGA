...
struct target_t {
	...
	/* LPM style components are handled here. */
	  ...
	  virtual void lpm_decoder(const NetDecoder*);//ADU:
      ...
      virtual void lpm_mem(const NetMem*);
      virtual void lpm_square(const NetSquare*);
      virtual void lpm_lmult(const NetLMult*);
	  virtual void lpm_lmultout(const NetLMultSimpleOUT*);
      virtual void lpm_mult_add(const NetMultAdd*);
	  virtual void lpm_mult_addout(const NetMultAddOut*);
      virtual void lpm_mult_accum(const NetMultAccum*);
      virtual void lpm_HalfDSPBlock(const HalfDSPBlock*);
