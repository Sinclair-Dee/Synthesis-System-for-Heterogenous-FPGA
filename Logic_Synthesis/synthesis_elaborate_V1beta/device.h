...
struct device_s {
	...
	/* These methods show various comparators */
	  ...
	  void (*show_cmp_le)(ivl_lpm_t net);//ADU
	  void (*show_cmp_lt)(ivl_lpm_t net);//ADU
	...
	/* Multipliers */
      ...
      void (*show_mip)(ivl_lpm_t net);
      void (*show_square)(ivl_lpm_t net);
      void (*show_lmult)(ivl_lpm_t net);
	  void (*show_lmultout)(ivl_lpm_t net);
      void (*show_mult_add)(ivl_lpm_t net);
      void (*show_mult_addout)(ivl_lpm_t net);
      void (*show_mult_accum)(ivl_lpm_t net);
      void (*show_halfdspblock)(ivl_lpm_t net);
	/* Constants */
      void (*show_constant)(ivl_net_const_t net);
	  void (*show_ramDq)(ivl_lpm_t net);
	  void (*show_decoder)(ivl_lpm_t net);//ADU:
};
