...
%token K_pll K_mem K_square K_mult K_mult_add K_mult_accum
...
module_item
  ...
  /* Continuous assignment can have an optional drive strength, then
	...
	| K_assign K_mem '(' expression_list ')' ';'
		{ pform_make_pmemassign($4, @1.text, @1.first_line); }

	| K_assign K_square '(' expression_list ')' ';'
		{ pform_make_psquareassign($4, @1.text, @1.first_line); }

	| K_assign K_mult '(' expression_list ')' ';'
		{ pform_make_pmultassign($4, @1.text, @1.first_line); }

	| K_assign K_mult_add '(' expression_list ')' ';'
		{ pform_make_pmultaddassign($4, @1.text, @1.first_line); }

	| K_assign K_mult_accum '(' expression_list ')' ';'
		{ pform_make_pmultaccumassign($4, @1.text, @1.first_line); }
