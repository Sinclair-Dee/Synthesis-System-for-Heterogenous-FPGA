...
void target_t::lpm_mem(const NetMem*)
{
      cerr << "target (" << typeid(*this).name() << "): "
	    "Unhandled NetMem." << endl;
}

void target_t::lpm_square(const NetSquare*)
{
      cerr << "target (" << typeid(*this).name() << "): "
	    "Unhandled NetSquare." << endl;
}

void target_t::lpm_lmult(const NetLMult*)
{
      cerr << "target (" << typeid(*this).name() << "): "
	    "Unhandled NetLMult." << endl;
}
void target_t::lpm_lmultout(const NetLMultSimpleOUT*)
{
	cerr << "target (" << typeid(*this).name() << "): "
		"Unhandled NetLMultout." << endl;
}
void target_t::lpm_mult_add(const NetMultAdd*)
{
      cerr << "target (" << typeid(*this).name() << "): "
	    "Unhandled NetMultAdd." << endl;
}
void target_t::lpm_mult_addout(const NetMultAddOut*)
{
	cerr << "target (" << typeid(*this).name() << "): "
		"Unhandled NetMultAddOut." << endl;
}

void target_t::lpm_mult_accum(const NetMultAccum*)
{
      cerr << "target (" << typeid(*this).name() << "): "
	    "Unhandled NetMultAccum." << endl;
}

void target_t::lpm_HalfDSPBlock(const HalfDSPBlock*)
{
	cerr << "target (" << typeid(*this).name() << "): "
		"Unhandled NetMultAccum." << endl;
}
...
void target_t::lpm_decoder(const NetDecoder*)
{
	cerr << "target (" << typeid(*this).name() << "): "
		"Unhandled NetDecoder." << endl;
}
