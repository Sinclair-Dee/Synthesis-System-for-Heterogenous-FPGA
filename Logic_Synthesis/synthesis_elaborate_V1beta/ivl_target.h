...
typedef enum ivl_lpm_type_e {
      ...
      IVL_LPM_CMP_GT =  2,
      IVL_LPM_CMP_NE = 11,
	  IVL_LPM_CMP_LE =  23,//ADU
	  IVL_LPM_CMP_LT =  24,//ADU
	  IVL_LPM_DECODER = 25,//ADU
      IVL_LPM_DECODE = 15,
      IVL_LPM_DEMUX  = 16,
      IVL_LPM_DIVIDE = 12,
      IVL_LPM_FF     =  3,
	  ...
	  IVL_LPM_LMULT  = 20,
	  IVL_LPM_MULT_ADD = 21,
	  IVL_LPM_MULT_ACCUM = 22,
	  IVL_LPM_LMULTOUT  = 26,
	  IVL_LPM_LMULTADDOUT  = 27,
	  IVL_LPM_HalfDSPBlock = 28
} ivl_lpm_type_t;
...
extern const char* ivl_lpm_attr_string(ivl_lpm_t net, const char*key);
...
extern ivl_nexus_t ivl_lpm_mip_sbit(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mip_address_a(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mip_address_b(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mip_data_a(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mip_data_b(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mip_q_a(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mip_q_b(ivl_lpm_t net, unsigned idx);
extern unsigned ivl_lpm_mip_width(ivl_lpm_t net, unsigned idx);
//DSP
extern ivl_nexus_t ivl_lpm_mult_sbit(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mult_data(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mult_dataa(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mult_datab(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mult_sum(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mult_scanouta(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mult_scanoutb(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_mult_result(ivl_lpm_t net, unsigned idx);
extern unsigned ivl_lpm_mult_width(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_multout_dataa(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_multout_result(ivl_lpm_t net, unsigned idx);
extern unsigned ivl_lpm_multout_width(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_halfdspblock_dataa0(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_halfdspblock_datab0(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_halfdspblock_dataa1(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_halfdspblock_datab1(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_halfdspblock_result(ivl_lpm_t net, unsigned idx);

extern ivl_nexus_t ivl_lpm_halfdspblock_clock(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_halfdspblock_ena(ivl_lpm_t net, unsigned idx);
extern ivl_nexus_t ivl_lpm_halfdspblock_accumsload(ivl_lpm_t net, unsigned idx);

extern unsigned ivl_lpm_halfdspblock_width(ivl_lpm_t net, unsigned idx);
//ivl_lpm_multout_dataa
//ivl_lpm_multout_result
...
//ADU_begin
extern unsigned ivl_lpm_ramDq_awidth(ivl_lpm_t net);
extern  unsigned ivl_lpm_ramDq_dwidth(ivl_lpm_t net);
extern  unsigned ivl_lpm_ramDq_depth(ivl_lpm_t net);

extern  ivl_nexus_t ivl_lpm_ramDq_inclock(ivl_lpm_t net);
extern ivl_nexus_t ivl_lpm_ramDq_outclock(ivl_lpm_t net);
extern ivl_nexus_t ivl_lpm_ramDq_we(ivl_lpm_t net);
extern  ivl_nexus_t ivl_lpm_ramDq_raddress(ivl_lpm_t net,int idx);
extern ivl_nexus_t ivl_lpm_ramDq_waddress(ivl_lpm_t net,int idx);
extern  ivl_nexus_t ivl_lpm_ramDq_data(ivl_lpm_t net,int idx);
extern  ivl_nexus_t ivl_lpm_ramDq_q(ivl_lpm_t net,int idx);

extern  unsigned ivl_lpm_decoder_width(ivl_lpm_t net);
extern  unsigned ivl_lpm_decoder_decodes(ivl_lpm_t net);
extern  ivl_nexus_t ivl_lpm_decoder_data(ivl_lpm_t net,int idx);
extern  ivl_nexus_t ivl_lpm_decoder_eq(ivl_lpm_t net,int idx);
//ADU_end
