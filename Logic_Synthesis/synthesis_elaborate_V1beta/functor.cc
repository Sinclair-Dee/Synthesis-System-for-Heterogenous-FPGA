...
void functor_t::lpm_lmultout(class Design*, class NetLMultSimpleOUT*)
{
}
...
void functor_t::lpm_mult_addout(class Design*, class NetMultAddOut*)
{
}
...
void functor_t::lpm_HalfDSPBlock(class Design*, class HalfDSPBlock*)
{
}
...
void NetLMultSimpleOUT::functor_node(Design*des, functor_t*fun)
{
	fun->lpm_lmultout(des, this);
}
...
void NetMultAddOut::functor_node(Design*des, functor_t*fun)
{
	fun->lpm_mult_addout(des, this);
}
...
void HalfDSPBlock::functor_node(Design*des, functor_t*fun)
{
	fun->lpm_HalfDSPBlock(des, this);
}
