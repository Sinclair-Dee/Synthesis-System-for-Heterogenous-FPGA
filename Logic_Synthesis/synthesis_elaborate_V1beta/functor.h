...
struct functor_t {
	...
	/* This method is called for each multiplier. */
      ...
      virtual void lpm_mem(class Design*des, class NetMem*);
	  //ADU: NetMemory
	  virtual void lpm_memory(class Design*des, class NetMemory*);

      virtual void lpm_square(class Design*des, class NetSquare*);

      virtual void lpm_lmult(class Design*des, class NetLMult*);

      virtual void lpm_lmultout(class Design*des, class NetLMultSimpleOUT*);

      virtual void lpm_mult_add(class Design*des, class NetMultAdd*);

      virtual void lpm_mult_addout(class Design*des, class NetMultAddOut*);

      virtual void lpm_mult_accum(class Design*des, class NetMultAccum*);

	  virtual void lpm_HalfDSPBlock(class Design*des, class HalfDSPBlock*);
